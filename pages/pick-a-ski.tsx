...
export default function PickASki() {
  ...
  return (
    <>
      ...
      <div className="py-12 sm:py-24 px-2">
        ...
        <div className="mx-auto px-6 lg:px-8">
          ...
          <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 lg:max-w-2xl mx-auto">
            <div className="sm:col-span-2 sm:col-start-1">
              <label htmlFor="bodyHeight" className="block text-sm font-medium leading-6 text-text">
                {texts.height[locale]}
              </label>
              <div className="mt-2">
                <input
                  ...
                  min="50"
                  max="250"
                  className="block w-full rounded-md border-0 py-1.5 text-text shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-text-muted focus:ring-2 focus:ring-inset focus:ring-accent-color sm:text-sm sm:leading-6"
                  onChange={(e) => {
            ...
            <div className="sm:col-span-2">
              <label htmlFor="bodyWeight" className="block text-sm font-medium leading-6 text-text">
                {texts.weight[locale]}
              </label>
              <div className="mt-2">
                <input
            ...
            <div className="sm:col-span-2">
              <label htmlFor="fitness" className="block text-sm font-medium leading-6 text-text">
            ...
            <dl className=" grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-2 lg:gap-y-16 mb-16 sm:mb-20 lg:mb-24">
              {fields.map((field) => (
                <div key={field.name} className="relative pl-16">
                  <dt className="text-base font-semibold leading-7 text-text" title={field.description}>
