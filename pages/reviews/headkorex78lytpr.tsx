...
export const getServerSideProps: GetServerSideProps = async (context) => {
    ...
    const photoFolderExists = checkFolderExists(reviews["Head Kore x 78 lyt pr"].brand, reviews["Head Kore x 78 lyt pr"].model);
...
export default function Review({ photoFolderExists }: ReviewProps) {
    return ReviewTemplate("Head Kore x 78 lyt pr", photoFolderExists)
}