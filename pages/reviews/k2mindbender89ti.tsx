...
export const getServerSideProps: GetServerSideProps = async (context) => {
    ...
    const photoFolderExists = checkFolderExists(reviews["K2 Mindbender 89Ti"].brand, reviews["K2 Mindbender 89Ti"].model);
...
export default function Review({ photoFolderExists }: ReviewProps) {
    return ReviewTemplate("K2 Mindbender 89Ti", photoFolderExists)
}