...
export const getServerSideProps: GetServerSideProps = async (context) => {
    ...
    const photoFolderExists = checkFolderExists(reviews["Extrem Factory 112"].brand, reviews["Extrem Factory 112"].model);
...
export default function Review({ photoFolderExists }: ReviewProps) {
    return ReviewTemplate("Extrem Factory 112", photoFolderExists)
}