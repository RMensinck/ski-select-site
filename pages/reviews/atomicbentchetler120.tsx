...
export const getServerSideProps: GetServerSideProps = async (context) => {
    ...
    const photoFolderExists = checkFolderExists(reviews["Atomic Bent Chetler 120"].brand, reviews["Atomic Bent Chetler 120"].model);
...
export default function Review({ photoFolderExists }: ReviewProps) {
    return ReviewTemplate("Atomic Bent Chetler 120", photoFolderExists)
}