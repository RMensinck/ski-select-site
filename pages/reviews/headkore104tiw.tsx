...
export const getServerSideProps: GetServerSideProps = async (context) => {
    ...
    const photoFolderExists = checkFolderExists(reviews["Head Kore 104 Ti W"].brand, reviews["Head Kore 104 Ti W"].model);
...
export default function Review({ photoFolderExists }: ReviewProps) {
    return ReviewTemplate("Head Kore 104 Ti W", photoFolderExists)
}