...
export const getServerSideProps: GetServerSideProps = async (context) => {
    ...
    const photoFolderExists = checkFolderExists(reviews["Head Crux 93 pro"].brand, reviews["Head Crux 93 pro"].model);
...
export default function Review({ photoFolderExists }: ReviewProps) {
    return ReviewTemplate("Head Crux 93 pro", photoFolderExists)
}