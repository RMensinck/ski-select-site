...
export const getServerSideProps: GetServerSideProps = async (context) => {
    ...
    const photoFolderExists = checkFolderExists(reviews["Head Oblivion jr junior"].brand, reviews["Head Oblivion jr junior"].model);
...
export default function Review({ photoFolderExists }: ReviewProps) {
    return ReviewTemplate("Head Oblivion jr junior", photoFolderExists)
}