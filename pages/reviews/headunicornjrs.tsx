...
export const getServerSideProps: GetServerSideProps = async (context) => {
    ...
    const photoFolderExists = checkFolderExists(reviews["Head Unicorn jrs"].brand, reviews["Head Unicorn jrs"].model);
...
export default function Review({ photoFolderExists }: ReviewProps) {
    return ReviewTemplate("Head Unicorn jrs", photoFolderExists)
}