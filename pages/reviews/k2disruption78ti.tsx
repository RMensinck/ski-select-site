...
export const getServerSideProps: GetServerSideProps = async (context) => {
    ...
    const photoFolderExists = checkFolderExists(reviews["K2 Disruption 78Ti"].brand, reviews["K2 Disruption 78Ti"].model);
...
export default function Review({ photoFolderExists }: ReviewProps) {
    return ReviewTemplate("K2 Disruption 78Ti", photoFolderExists)
}