...
export const getServerSideProps: GetServerSideProps = async (context) => {
    ...
    const photoFolderExists = checkFolderExists(reviews["Head Supershape v4"].brand, reviews["Head Supershape v4"].model);
...
export default function Review({ photoFolderExists }: ReviewProps) {
    return ReviewTemplate("Head Supershape v4", photoFolderExists)
}