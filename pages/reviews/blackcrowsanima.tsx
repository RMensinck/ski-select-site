...
export const getServerSideProps: GetServerSideProps = async (context) => {
    ...
    const photoFolderExists = checkFolderExists(reviews["Black Crows Anima"].brand, reviews["Black Crows Anima"].model);
...
export default function Review({ photoFolderExists }: ReviewProps) {
    return ReviewTemplate("Black Crows Anima", photoFolderExists)
}