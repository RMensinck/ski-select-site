...
export const getServerSideProps: GetServerSideProps = async (context) => {
    ...
    const photoFolderExists = checkFolderExists(reviews["Extrem Factory 102"].brand, reviews["Extrem Factory 102"].model);
...
export default function Review({ photoFolderExists }: ReviewProps) {
    return ReviewTemplate("Extrem Factory 102", photoFolderExists)
}