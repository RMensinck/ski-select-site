...
export const getServerSideProps: GetServerSideProps = async (context) => {
    ...
    const photoFolderExists = checkFolderExists(reviews["Black Crows Camox"].brand, reviews["Black Crows Camox"].model);
...
export default function Review({ photoFolderExists }: ReviewProps) {
    return ReviewTemplate("Black Crows Camox", photoFolderExists)
}