const textsNewHome = {
    upperTextbox: {
        "en": "Share your opinion now on the new opinions page!",
        "nl": "Deel nu je mening op de nieuwe meningen pagina!",
        "ja": "新しい意見ページで今すぐあなたの意見を共有しましょう！",
        "es": "¡Comparte tu opinión ahora en la nueva página de opiniones!",
        "de": "Teile jetzt deine Meinung auf der neuen Meinungsseite!",
        "pl": "Podziel się teraz swoją opinią na nowej stronie opinii!",
        "fr": "Partagez dès maintenant votre avis sur la nouvelle page des avis !"
      },
    readMore: {
        "en": "Read more",
        "nl": "Lees meer",
    ...
    title: {
        "en": "Pick-a-ski: the tool to find the ski that suits you!",
        "nl": "Pick-a-ski: de tool om de ski te vinden die bij je past!",
        "ja": "ピック・ア・スキー：あなたに合ったスキーを見つけるためのツール！",
        "es": "Pick-a-ski: ¡la herramienta para encontrar el esquí que te conviene!",
        "de": "Pick-a-ski: das Tool, um den Ski zu finden, der zu dir passt!",
        "pl": "Pick-a-ski: narzędzie do znalezienia nart, które są dla ciebie odpowiednie!",
        "fr": "Pick-a-ski : l'outil pour trouver le ski qui vous convient !"
      },
    body: {
        ...
        "fr": "La préférence pour le ski est personnelle pour chacun, mais de nos jours le monde du ski est devenu une grande jungle de marketing. Notre outil vous aide à trouver rapidement et gratuitement le ski qui vous convient, sans perdre de vue la forêt à cause des arbres."
      }
