const textsOpinions = {
  metaDescription: {
    "en": "Explore our opinions page to see what others think about a wide range of skis and share your own experiences. This is your platform to discuss, rate, and learn from real-user opinions on every ski model available.",
    "nl": "Bekijk onze meningenpagina om te zien wat anderen vinden van een breed scala aan ski's en deel uw eigen ervaringen. Dit is uw platform om te discussiëren, te beoordelen en te leren van echte gebruikersmeningen over elk beschikbaar skimodel.",
    "de": "Entdecken Sie unsere Meinungsseite, um herauszufinden, was andere über eine Vielzahl von Skiern denken und teilen Sie Ihre eigenen Erfahrungen. Dies ist Ihre Plattform, um zu diskutieren, zu bewerten und von den Meinungen echter Nutzer zu jedem verfügbaren Skimodell zu lernen.",
    "ja": "私たちの意見ページを探索して、さまざまなスキーについて他の人がどう思っているかを確認し、自分自身の経験を共有しましょう。これは、利用可能なすべてのスキーモデルについて、実際のユーザーの意見を議論し、評価し、学ぶためのあなたのプラットフォームです。",
    "fr": "Explorez notre page d'opinions pour voir ce que les autres pensent d'une large gamme de skis et partagez vos propres expériences. C'est votre plateforme pour discuter, évaluer et apprendre des opinions des vrais utilisateurs sur chaque modèle de ski disponible.",
    "es": "Explore nuestra página de opiniones para ver lo que otros piensan sobre una amplia gama de esquís y comparta sus propias experiencias. Esta es su plataforma para discutir, calificar y aprender de las opiniones de usuarios reales sobre cada modelo de esquí disponible.",
