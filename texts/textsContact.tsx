const textsContact = {
  metaDescription: {
    "en": "Get in touch with us! Visit our contact page for all the information you need to connect with our team. Whether you have questions, feedback, or need support, we're here to help you every step of the way.",
    "nl": "Neem contact met ons op! Bezoek onze contactpagina voor alle informatie die u nodig heeft om in contact te komen met ons team. Of u nu vragen heeft, feedback wilt geven of ondersteuning nodig heeft, wij staan voor u klaar.",
    "de": "Kontaktieren Sie uns! Besuchen Sie unsere Kontaktseite für alle Informationen, die Sie benötigen, um mit unserem Team in Verbindung zu treten. Ob Sie Fragen haben, Feedback geben oder Unterstützung benötigen, wir sind jederzeit für Sie da.",
    "ja": "お問い合わせください！当チームと連絡を取るために必要なすべての情報が記載されたお問い合わせページをご覧ください。ご質問、フィードバック、またはサポートが必要な場合でも、私たちはいつでもお手伝いします。",
    "fr": "Contactez-nous ! Visitez notre page de contact pour toutes les informations nécessaires pour vous connecter avec notre équipe. Que vous ayez des questions, des retours ou que vous ayez besoin de soutien, nous sommes là pour vous aider à chaque étape.",
    "es": "¡Póngase en contacto con nosotros! Visite nuestra página de contacto para toda la información que necesite para conectarse con nuestro equipo. Ya sea que tenga preguntas, comentarios o necesite soporte, estamos aquí para ayudarle en cada paso del camino.",
  ...
  email: {
    ...
    "nl": "e-mail: remco@pick-a-ski.com",
    "ja": "メール: remco@pick-a-ski.com",
    "es": "correo electrónico: remco@pick-a-ski.com",
