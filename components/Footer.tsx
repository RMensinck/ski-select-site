...
export default function Footer() {
  ...
  const { locale } = router 
  const article1 = articles.find((a) => a.id === "6")
  const article2 = articles.find((a) => a.id === "5")
  const article3 = articles.find((a) => a.id === "4")
  const article4 = articles.find((a) => a.id === "2")
  ...
  const navigation = {
    ...
    topPicks: [
      { name: article1.title[locale], href: article1.href },
      { name: article2.title[locale], href: article2.href },
    ],
    learnMore: [
      { name: article3.title[locale], href: article3.href },
      { name: article4.title[locale], href: article4.href },
    ],
    aboutUs: [
